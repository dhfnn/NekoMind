...
<div class="col col-md-11 kage mb-3 px-3 px-md-5 pb-3 pt-1" style="border:1px rgba(0, 0, 0, 0.082) solid; border-radius:10px;">
    <div class="col d-flex">
        ...
        <div class="col">
            ...
            <textarea class="form-control" name="pertanyaan{{ $i }}" rows="4"></textarea>
        </div>
    </div>
    <div class="row row-cols-1  mt-4">
        <div class="col">
            <div class="col mt-2 d-flex align-items-center flex-column">
                <div class="col-12 mt-2 d-flex align-items-center">
                    <span>A.</span>
                    <input class="form-control ms-3" type="text" name="opsi{{ $i }}[]">
                </div>
                <div class="col-12 mt-2 d-flex align-items-center">
                    <span>B.</span>
                    <input class="form-control ms-3" type="text" name="opsi{{ $i }}[]">
        ...
        <div class="d-flex justify-content-end mt-3">
            <div class="">
                ...
                <select class="p-1" style="border-radius: 10px; border:1px rgba(0, 0, 0, 0.144) solid;" name="jawaban{{ $i }}">
