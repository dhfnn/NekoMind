<form action="{{ route('ujian.delete', ['id'=>$data->id]) }}" method="POST">
    @csrf
    @method('DELETE')
<div class="modal fade" id="exampleModal09{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
          ...
          <div class="modal-body py-0">
            <p>Apakah anda yakin akan menghapus data dari <b>{{ $data->judul }}</b> ? </p>
          </div>
